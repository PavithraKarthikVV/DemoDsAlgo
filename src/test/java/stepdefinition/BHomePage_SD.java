...
public class BHomePage_SD {
	...
	public void user_clicks_on_button(String getStarted) {
	...
	@When("The user click GetStart in {string}")
	public void the_user_click_get_start_in_array(String string) {
		
	   array=homePage.getstartCotainer(string);
	}
